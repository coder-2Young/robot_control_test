...
//  { return operator=<Derived>(other); }
  ...
  template<class OtherDerived> EIGEN_DEVICE_FUNC Quaternion<Scalar> slerpLongWay(const Scalar& t, const QuaternionBase<OtherDerived>& other) const;
...
template <class OtherDerived>
EIGEN_DEVICE_FUNC Quaternion<typename internal::traits<Derived>::Scalar>
QuaternionBase<Derived>::slerpLongWay(const Scalar& t, const QuaternionBase<OtherDerived>& other) const
{
  EIGEN_USING_STD_MATH(acos)
  EIGEN_USING_STD_MATH(sin)
  const Scalar one = Scalar(1) - NumTraits<Scalar>::epsilon();
